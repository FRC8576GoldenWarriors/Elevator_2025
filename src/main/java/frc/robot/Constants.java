...
public class Constants {
  public class ElevatorConstants {
    ...
    public static final double kP = 0.004;//0.008//0.0056;//0.0048;//0.075;//12.8;//6.4;//3.2;//1;//4.8; // 4.8//4.6;//4.65//4.0//0.5//4.8;//7.2, 4.8
    ...
    public static final double feetToRot = 1815.791667;//1873.666667;//69.2355;
